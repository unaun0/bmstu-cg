...
<p class="has-line-data" data-line-start="2" data-line-end="3">Название: Отсечение отрезка нерегулярным отсекателем</p>
...
<p class="has-line-data" data-line-start="10" data-line-end="11">Реализация и исследование алгоритма отсечения отрезка нерегулярным отсекателем методом Кируса-Бека.</p>
</u>
</body></html>
'''))
